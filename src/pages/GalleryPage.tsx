...
const GalleryPage: React.FC = () => {
  // Simulating a list of images. In a real app, these would come from an API or CMS.
  const images: GalleryItem[] = Array.from({ length: 9 }).map((_, i) => ({
    id: i,
    url: `https://picsum.photos/800/800?random=${i + 10}`,
    caption: [
      "Contemplating the meaning of the red dot",
